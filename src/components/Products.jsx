    ...
    <div className='flex flex-col justify-center bg-gray-200'>
      ...
      <div className='flex flex-col md:flex-row justify-around gap-4 md:gap-10 items-center px-20 py-5'>
        <div className='flex flex-row gap-7'>
          <div>
          <h1 className='md:text-2xl text-xl font-row-font mt-10 text-center mb-10'>Spartans-Kart</h1>
          </div>
      ...
      <div className='bg-red-950 text-white'>
        <h1 className='flex md:flex-row flex-col items-center md:justify-center md:text-4xl text-md font-semibold font-list-font px-10 md:py-20 py-10 text-center'>Welcome to Our Upgraded Spartans-Cart <BsCart4 size={36} /></h1>
      </div>
